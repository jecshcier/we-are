...
$.fn.wl_File = function (method) {
	...
	return this.each(function () {
		...
		if (!$this.data('wl_File')) {
			...
			opts.filepool = $('<ul class="fileuploadpool multiple drop" style="width:300px; height:100px; overflow:auto;" >', {
			...
			$('ul.fileuploadpool li').wrapAll('<div style="width:100px; height:100px; border:1px solid #00f; "></div>');	
