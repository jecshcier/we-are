...
var md5 = require('./assets/lib/md5');
var sql = require('./assets/sql/sql');
// var userSql = require('./assets/sql/userSql.js');
var skydiskApi = require('./assets/skydiskApi/useApi');
var config = require('../config');
var fs = require('fs-extra');
var ejsUrl = config.projectName;
var staticUrl = config.static;
var txUrl = config.Tx;
var imgUrl = config.img;
/*登录页面*/
